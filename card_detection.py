...
class AdvancedTemplateMatcher:
    ...
    def match_card(self, card_image: np.ndarray, confidence_threshold: float = 0.3) -> Optional[str]:
        ...
        try:
            ...
            if best_confidence > confidence_threshold:
                ...
                self.logger.log(
                    f"No match found (best: {best_match} at {best_confidence:.3f}, threshold: {confidence_threshold})")
                return None
    ...
    def debug_card_matching(self, card_image: np.ndarray) -> Dict:
...
class CardDetector:
    ...
    def debug_card_detection(self, card_image, card_type="unknown"):
        ...
        return self.template_matcher.debug_card_matching(card_image)
